...
const Template: Story<Pick<NavBarProps, 'sticky'>> = (props) => {
  return (
    <>
      <Box padding={[300, 300, 300, 300]} spacing={[250]}>
        <Font variant="h5">Some header</Font>
        <Font variant="b2">
          ...
          below for those interested. Sections 1.10.32 and 1.10.33 from web
          ...
          interested. Sections 1.10.32 and 1.10.33 from web sites still in their
