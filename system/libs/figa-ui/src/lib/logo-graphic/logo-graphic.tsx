import type { LogoGraphicProps } from './defs';
import c from 'classnames';

const LogoGraphic = ({ className, size }: LogoGraphicProps) => (
  <svg
    className={c('logo-graphic', className)}
    width={size}
    height={size}
    viewBox={`0 0 52 52`}
    fill="none"
  ...
  >
    ...
    <defs>
      ...
      >
        <stop className="logo-bg-first-from" />
        <stop className="logo-bg-first-to" offset="1" />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop className="logo-bg-second-from" />
        <stop className="logo-bg-second-to" offset="1" />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop className="logo-bg-last-from" />
        <stop className="logo-bg-last-to" offset="1" />
      </linearGradient>
    </defs>
  </svg>
);
