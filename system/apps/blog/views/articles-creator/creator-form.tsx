...
const CreatorForm = () => {
    ...
    const { thumbnail, title, description, lang } = articleCreatorState.form.values
    ...
    >
        <FilePicker
            ...
            onChange={(files, preview) =>
                articles_creator_actions.change('thumbnail', { file: files[0], preview })
            }
            onConfirm={() => {
                articles_creator_actions.change('thumbnail', { file: null, preview: [] })
            }}
        >
